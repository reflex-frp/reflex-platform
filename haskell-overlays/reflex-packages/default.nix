{ haskellLib
, lib, nixpkgs
, thunkSet, fetchFromGitHub, fetchFromBitbucket, thunkImport
...
let
  ...
  wasmCross = thunkImport ../../wasm-cross;
...
in
{
  ...
  jsaddle-wasm = self.callCabal2nix "jsaddle-wasm" (thunkImport (wasmCross + /jsaddle-wasm)) {};
